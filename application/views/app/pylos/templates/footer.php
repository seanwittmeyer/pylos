		...
		<div class="modal-dialog modal-dialog-login">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="panel panel-default">
						<div class="panel-body">
							<a href="<?php // /auth/facebook ?>" class="btn btn-lg btn-primary btn-block" onclick="$(this).text('signing you in...');">Log in / Sign up with <?php // Facebook ?>SAML &rarr;</a>
						</div>
					</div>
					<h3>or...</h3>
					<div class="panel panel-default">
	...
	<footer class="container-fluid build-wrapper">
		<div class="row">
	...
	<script>
		$.embedly.defaults.key = '74435e49e8fa468eb2602ea062017ceb'; // *requests from pylos.zgf.com domain
	...
	<script type="text/javascript">
		...
		$('.pylos-summernote').summernote({
			...
			placeholder: 'Describe this and include how it works and any information people will need to use it...',
		});
