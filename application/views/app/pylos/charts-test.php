...
<head>
  ...
  <link rel="stylesheet" href="/includes/app/raw/bower_components/bootstrap/dist/css/bootstrap.min.css"/>
  ...
  <link rel="icon" href="/includes/app/raw/favicon.ico?v=2" type="image/x-icon">
  <link rel="shortcut icon" href="/includes/app/raw/favicon.ico" type="image/x-icon">
...
<body data-spy="scroll" data-target="#raw-nav">
  ...
  <header class="navbar navbar-static-top" role="navigation" id="raw-nav" role="banner">
    <div class="container">
     <div class="navbar-header">
        ...
        <a class="navbar-brand" href="//rawgraphs.io/" target="_blank">
          <img alt="RawGraphs" src="/includes/app/raw/imgs/rawgraphslogo.png">
        </a>
      </div>

      <nav class="collapse navbar-collapse" role="navigation" id="raw-navbar">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="//rawgraphs.io/about/" target="_blank">About</a></li>
          <li><a href="//rawgraphs.io/gallery/" target="_blank">Gallery</a></li>
          <li><a href="//rawgraphs.io/learning/" target="_blank">Learning</a></li>
  ...
  <div id="footer">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <p><strong>RAW</strong> is an open source project by <a href="//www.densitydesign.org">DensityDesign Lab</a> and <a href="//calib.ro">Calibro</a></p>
          <p><a href="https://www.giorgiocaviglia.com" target="_blank">Giorgio Caviglia,</a> <a href="//www.densitydesign.org/person/michele-mauri/" target="_blank">Michele Mauri</a>, <a href="//calib.ro" target="_blank">Giorgio Uboldi</a>, <a href="//calib.ro" target="_blank">Matteo Azzi</a></p>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
          ...
          <p><a href="//twitter.com/rawgraphs"><i class="fa fa-twitter breath-right"></i>rawgraphs</a></p>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
          <p><a href="//github.com/densitydesign/raw"><i class="fa fa-github breath-right"></i>GitHub</a></p>
