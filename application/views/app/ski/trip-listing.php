		...
		<div class="row">
			<div class="col-md-12">
				<div class="bs-component">
					<div class="" id="imgheader" style="padding-top: 50px; padding-left: 50px;">
						<div class="container">
							<h1 class="label-hanger">2019</h1>
							<a class="gallery-hero-text" style="background-image: url('/upload/img/b6efb39a4fe9d614c1bf8a0586499ce0.jpeg');">Death Valley&nbsp;</a>
							...
							<a href="/trips/lyon" class="gallery-hero-text" style="background-image: url('http://photos.seanwittmeyer.com/images/Personal/2018/Polly%20and%20Dave%2050th/SWP_8182.jpg');">Palm Springs&nbsp;</a>
							<p class="trip-subtitle">This is a 13 day trip to the South of France with a variety of people spanning from June 13 through the 25th.</p>
							<h1 class="label-hanger">2018</h1>
							<a class="gallery-hero-text" style="background-image: url('http://photos.seanwittmeyer.com/images/Mexico/DayoftheDead/8-Desfile-de-Muertos/SWP_6451.jpg');">Mexico City&nbsp;</a>
							<p class="trip-subtitle">This is a 13 day trip to the South of France with a variety of people spanning from June 13 through the 25th.</p>
							<a class="gallery-hero-text" style="background-image: url('http://photos.seanwittmeyer.com/images/France/Aix2018/SWP_4512.jpg');">Provence&nbsp;</a>
							<p class="trip-subtitle">This is a 13 day trip to the South of France with a variety of people spanning from June 13 through the 25th.</p>
							<a class="gallery-hero-text" style="background-image: url('http://photos.seanwittmeyer.com/images/France/Nimes/SWP_2066.jpg');">Nimes&nbsp;</a>
							<p class="trip-subtitle">This is a 13 day trip to the South of France with a variety of people spanning from June 13 through the 25th.</p>
							<a class="gallery-hero-text" style="background-image: url('http://photos.seanwittmeyer.com/images/France/Lyon/SWP_1443.jpg');">Lyon&nbsp;</a>
							<p class="trip-subtitle">This is a 13 day trip to the South of France with a variety of people spanning from June 13 through the 25th.</p>
							<a class="gallery-hero-text" style="background-image: url('http://photos.seanwittmeyer.com/images/Digicam/2013/3%20Island%20in%20the%20Sky/6155.jpg');">Canyonlands&nbsp;</a>
							<p class="trip-subtitle">This is a 13 day trip to the South of France with a variety of people spanning from June 13 through the 25th.</p>
							<a class="gallery-hero-text" style="background-image: url('http://photos.seanwittmeyer.com/images/Italia/Bormio/SWP_8251.jpg');">Bormio &amp; Bolzano&nbsp;</a>
							<p class="trip-subtitle">This is a 13 day trip to the South of France with a variety of people spanning from June 13 through the 25th.</p>
							<h1 class="label-hanger">2017</h1>
							<a class="gallery-hero-text" style="background-image: url('http://photos.seanwittmeyer.com/images/America/DenverArtMuseum/SWP_2092.jpg');">Denver&nbsp;</a>
							<p class="trip-subtitle">This is a 13 day trip to the South of France with a variety of people spanning from June 13 through the 25th.</p>
							<a class="gallery-hero-text" style="background-image: url('http://photos.seanwittmeyer.com/images/Italia/Bormio/SWP_8275.jpg');">Portland&nbsp;</a>
							<p class="trip-subtitle">This is a 13 day trip to the South of France with a variety of people spanning from June 13 through the 25th.</p>
							<a class="gallery-hero-text" style="background-image: url('http://photos.seanwittmeyer.com/images/France/Montpillier/swp.france.656.jpg');">Lyon&nbsp;</a>
							<p class="trip-subtitle">This is a 13 day trip to the South of France with a variety of people spanning from June 13 through the 25th.</p>
