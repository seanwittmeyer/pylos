...
class Trips extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('app/ski/trip-listing', $data);
		$this->load->view('app/builder/templates/footer', $data);
	}

	public function tripsingle()
	{
		$data['pagetitle'] = 'Brussels'; // Capitalize the first letter
		$data['section'] = 'trip';
		$data['loadjs']['nanogallery'] = true;
		$data['loadjs']['mapbox'] = true;
		$this->load->view('app/builder/templates/header', $data);
		$this->load->view('app/ski/trip-single', $data);
		$this->load->view('app/builder/templates/footer', $data);
	}
	...
	public function api()
	{
		define('NANOFOLDER','img/Peru/Lima');
		$this->load->library('gallery', null, 'gggg');
	}
	...
	public function api_ski($method=null, $arg=null, $arg2=null)
	{
		// authenticated?
