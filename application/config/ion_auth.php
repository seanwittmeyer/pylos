...
*/
$config['tables']['users']           = 'build_users';
$config['tables']['groups']          = 'build_groups';
$config['tables']['users_groups']    = 'build_users_groups';
$config['tables']['login_attempts']  = 'build_login_attempts';
...
$config['bcrypt_default_cost']		= 8;		// Set cost according to your server benchmark - but no lower than 10 (default PHP value)
$config['bcrypt_admin_cost']		= 8;		// Cost for user in admin group
 ...
 */
$config['site_title']                 = getenv("BUILDER_PYLOS_SITENAME");       // Site Title, example.com
$config['admin_email']                = getenv("BUILDER_PYLOS_EMAIL"); // Admin Email, admin@example.com
