...
<body data-spy="scroll" data-target="#raw-nav">
	...
	<div class="container-fluid build-wrapper">
		<div class="row">
			<div class="col-sm-2"><h3 class="text-left hidden-lg"><a href="/pylos/" style="color:#3e3f3a;">Pylos</a></h3></div>
			<div class="col-sm-10 hidden-xs"></div>
		</div>
	</div>
	<div class="container-fluid build-wrapper">
		<div class="row">
			...
			<div class="col-sm-2">
				<div class="row">
					<div class="col-sm-12 hidden-xs">
						<div class="headline-parent"><h3 class="text-left headline"><a href="/pylos/" style="color:#3e3f3a;">Pylos</a></h3></div>
					</div>
